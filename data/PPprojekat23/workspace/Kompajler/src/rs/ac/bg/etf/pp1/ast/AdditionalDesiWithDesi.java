...
public class AdditionalDesiWithDesi extends AdditionalDesignators {

    private Designator Designator;
    private AdditionalDesignators AdditionalDesignators;

    public AdditionalDesiWithDesi (Designator Designator, AdditionalDesignators AdditionalDesignators) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("AdditionalDesiWithDesi(\n");
