...
public class CstrDecl extends MethodOrCstrDeclarations {
    ...
    public CstrDecl (MethodOrCstrDeclarations MethodOrCstrDeclarations, MethodName MethodName, FormPars FormPars, VarDeclarations VarDeclarations, StatementList StatementList) {
