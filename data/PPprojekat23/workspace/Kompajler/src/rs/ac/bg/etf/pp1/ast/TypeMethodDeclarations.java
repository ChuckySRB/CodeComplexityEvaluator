...
public class TypeMethodDeclarations extends MethodDeclarations {
    ...
    public TypeMethodDeclarations (MethodDeclarations MethodDeclarations, FunType FunType, MethodName MethodName, FormPars FormPars, VarDeclarations VarDeclarations, StatementList StatementList) {
        this.MethodDeclarations=MethodDeclarations;
        if(MethodDeclarations!=null) MethodDeclarations.setParent(this);
        this.FunType=FunType;
        if(FunType!=null) FunType.setParent(this);
    ...
    public void childrenAccept(Visitor visitor) {
        ...
        if(FunType!=null) FunType.accept(visitor);
    ...
    public void traverseTopDown(Visitor visitor) {
        ...
        if(FunType!=null) FunType.traverseTopDown(visitor);
    ...
    public void traverseBottomUp(Visitor visitor) {
        ...
        if(FunType!=null) FunType.traverseBottomUp(visitor);
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("TypeMethodDeclarations(\n");
        ...
        if(FunType!=null)
            buffer.append(FunType.toString("  "+tab));
        else
            buffer.append(tab+"  null");
        buffer.append("\n");
